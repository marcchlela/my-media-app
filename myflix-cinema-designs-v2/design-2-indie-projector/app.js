...
function render() {
  document.getElementById('app').innerHTML = `
    <div class="app indie">
      ...
      <div class="projector-source"></div>
      ${sidebar(`<div class="indie-lounge"><div class="wall-light"></div><div class="sofa"></div></div>`)}
      <main class="main">
        ${topbar()}
        <section class="indie-hero">
          <div class="section-head now-head"><h2>Now Showing</h2><span>3 screens active</span></div>
          <div class="large-posters">${nowShowing.map(item => posterCard(item, 'gallery-poster')).join('')}</div>
        </section>
